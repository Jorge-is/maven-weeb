                    ...
                    <div class="jumbo-form">
                        <form id="contactForm" method="POST" action="" class="formulario">
                            <fieldset>
                                ...
                                <input type="text" id="imagen" name="imagen" placeholder="Escriba la ruta de la imagen" value="<?php echo e($imagen); ?>" required>
                                <label for="contenido">Contenido:</label>
                                <textarea id="contenido" name="contenido" placeholder="Escriba el contenido del blog" required><?php echo e($contenido); ?></textarea>
                                ...
                                <input type="hidden" name="id_editor" value="<?php echo (int)($_SESSION['id_editor'] ?? 0); ?>">
