<?php
    ...
    $menu = [
        "Inicio"             => "intranet.php",
        "Editores"           => "editores_administrador.php",
        "Clientes"           => "clientes_administrador.php",
        "Blogs"              => "blogs_gestionar.php",
        "Servicios"          => "servicios_gestionar.php",
        "Mensajes"           => "mensajes_administrador.php",
    ];
?>
    ...
    <nav>
        <div class="nav-inner">
            <div class="nav-left">
                ...
                <a href="intranet.php" class="nav-logo-link">
